...
Download the following cheatsheet from [The Markdown Guide](https://www.markdownguide.org) for handy inline syntax when composing R Markdown files like those used in my tutorials.

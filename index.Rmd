...
##  [`microbiome_tidy_alignments.html`](https://rich-molecular-health-lab.github.io/tutorials/microbiome_tidy_alignments.html)
...
1.  `alignments.tsv` - *raw alignment data gathered from the wf-16s output and organized into one table in the previous script*
